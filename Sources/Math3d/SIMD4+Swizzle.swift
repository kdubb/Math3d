...
extension SIMD4 where Scalar: ExpressibleByIntegerLiteral {
  ...
  public var xz: SIMD2<Scalar> { get { SIMD2<Scalar>(x, z) } set { x = newValue.x; z = newValue.y } }
  public var xw: SIMD2<Scalar> { get { SIMD2<Scalar>(x, w) } set { x = newValue.x; w = newValue.y } }
  public var yx: SIMD2<Scalar> { get { SIMD2<Scalar>(y, x) } set { y = newValue.x; x = newValue.y } }
  public var yy: SIMD2<Scalar> { SIMD2<Scalar>(y, y) }
  public var yz: SIMD2<Scalar> { get { SIMD2<Scalar>(y, z) } set { y = newValue.x; z = newValue.y } }
  public var yw: SIMD2<Scalar> { get { SIMD2<Scalar>(y, w) } set { y = newValue.x; w = newValue.y } }
  public var zx: SIMD2<Scalar> { get { SIMD2<Scalar>(z, x) } set { z = newValue.x; x = newValue.y } }
  public var zy: SIMD2<Scalar> { get { SIMD2<Scalar>(z, y) } set { z = newValue.x; y = newValue.y } }
  public var zz: SIMD2<Scalar> { SIMD2<Scalar>(z, z) }
  public var zw: SIMD2<Scalar> { get { SIMD2<Scalar>(z, w) } set { z = newValue.x; w = newValue.y } }
  public var wx: SIMD2<Scalar> { get { SIMD2<Scalar>(w, x) } set { w = newValue.x; x = newValue.y } }
  public var wy: SIMD2<Scalar> { get { SIMD2<Scalar>(w, y) } set { w = newValue.x; y = newValue.y } }
  public var wz: SIMD2<Scalar> { get { SIMD2<Scalar>(w, z) } set { w = newValue.x; z = newValue.y } }
  ...
  public var rb: SIMD2<Scalar> { get { SIMD2<Scalar>(r, b) } set { r = newValue.x; b = newValue.y } }
  public var ra: SIMD2<Scalar> { get { SIMD2<Scalar>(r, a) } set { r = newValue.x; a = newValue.y } }
  public var gr: SIMD2<Scalar> { get { SIMD2<Scalar>(g, r) } set { g = newValue.x; r = newValue.y } }
  public var gg: SIMD2<Scalar> { SIMD2<Scalar>(g, g) }
  public var gb: SIMD2<Scalar> { get { SIMD2<Scalar>(g, b) } set { g = newValue.x; b = newValue.y } }
  public var ga: SIMD2<Scalar> { get { SIMD2<Scalar>(g, a) } set { g = newValue.x; a = newValue.y } }
  public var br: SIMD2<Scalar> { get { SIMD2<Scalar>(b, r) } set { b = newValue.x; r = newValue.y } }
  public var bg: SIMD2<Scalar> { get { SIMD2<Scalar>(b, g) } set { b = newValue.x; g = newValue.y } }
  public var bb: SIMD2<Scalar> { SIMD2<Scalar>(b, b) }
  public var ba: SIMD2<Scalar> { get { SIMD2<Scalar>(b, a) } set { b = newValue.x; a = newValue.y } }
  public var ar: SIMD2<Scalar> { get { SIMD2<Scalar>(a, r) } set { a = newValue.x; r = newValue.y } }
  public var ag: SIMD2<Scalar> { get { SIMD2<Scalar>(a, g) } set { a = newValue.x; g = newValue.y } }
  public var ab: SIMD2<Scalar> { get { SIMD2<Scalar>(a, b) } set { a = newValue.x; b = newValue.y } }
  ...
  public var sp: SIMD2<Scalar> { get { SIMD2<Scalar>(s, p) } set { s = newValue.x; p = newValue.y } }
  public var sq: SIMD2<Scalar> { get { SIMD2<Scalar>(s, q) } set { s = newValue.x; q = newValue.y } }
  public var ts: SIMD2<Scalar> { get { SIMD2<Scalar>(t, s) } set { t = newValue.x; s = newValue.y } }
  public var tt: SIMD2<Scalar> { SIMD2<Scalar>(t, t) }
  public var tp: SIMD2<Scalar> { get { SIMD2<Scalar>(t, p) } set { t = newValue.x; p = newValue.y } }
  public var tq: SIMD2<Scalar> { get { SIMD2<Scalar>(t, q) } set { t = newValue.x; q = newValue.y } }
  public var ps: SIMD2<Scalar> { get { SIMD2<Scalar>(p, s) } set { p = newValue.x; s = newValue.y } }
  public var pt: SIMD2<Scalar> { get { SIMD2<Scalar>(p, t) } set { p = newValue.x; t = newValue.y } }
  public var pp: SIMD2<Scalar> { SIMD2<Scalar>(p, p) }
  public var pq: SIMD2<Scalar> { get { SIMD2<Scalar>(p, q) } set { p = newValue.x; q = newValue.y } }
  public var qs: SIMD2<Scalar> { get { SIMD2<Scalar>(q, s) } set { q = newValue.x; s = newValue.y } }
  public var qt: SIMD2<Scalar> { get { SIMD2<Scalar>(q, t) } set { q = newValue.x; t = newValue.y } }
  public var qp: SIMD2<Scalar> { get { SIMD2<Scalar>(q, p) } set { q = newValue.x; p = newValue.y } }
  ...
  public var xyz: SIMD3<Scalar> { get { SIMD3<Scalar>(x, y, z) } set { x = newValue.x; y = newValue.y; z = newValue.z } }
  public var xyw: SIMD3<Scalar> { get { SIMD3<Scalar>(x, y, w) } set { x = newValue.x; y = newValue.y; w = newValue.z } }
  public var xzx: SIMD3<Scalar> { SIMD3<Scalar>(x, z, x) }
  public var xzy: SIMD3<Scalar> { get { SIMD3<Scalar>(x, z, y) } set { x = newValue.x; z = newValue.y; y = newValue.z } }
  public var xzz: SIMD3<Scalar> { SIMD3<Scalar>(x, z, z) }
  public var xzw: SIMD3<Scalar> { get { SIMD3<Scalar>(x, z, w) } set { x = newValue.x; z = newValue.y; w = newValue.z } }
  public var xwx: SIMD3<Scalar> { SIMD3<Scalar>(x, w, x) }
  public var xwy: SIMD3<Scalar> { get { SIMD3<Scalar>(x, w, y) } set { x = newValue.x; w = newValue.y; y = newValue.z } }
  public var xwz: SIMD3<Scalar> { get { SIMD3<Scalar>(x, w, z) } set { x = newValue.x; w = newValue.y; z = newValue.z } }
  ...
  public var yxz: SIMD3<Scalar> { get { SIMD3<Scalar>(y, x, z) } set { y = newValue.x; x = newValue.y; z = newValue.z } }
  public var yxw: SIMD3<Scalar> { get { SIMD3<Scalar>(y, x, w) } set { y = newValue.x; x = newValue.y; w = newValue.z } }
  ...
  public var yzx: SIMD3<Scalar> { get { SIMD3<Scalar>(y, z, x) } set { y = newValue.x; z = newValue.y; x = newValue.z } }
  public var yzy: SIMD3<Scalar> { SIMD3<Scalar>(y, z, y) }
  public var yzz: SIMD3<Scalar> { SIMD3<Scalar>(y, z, z) }
  public var yzw: SIMD3<Scalar> { get { SIMD3<Scalar>(y, z, w) } set { y = newValue.x; z = newValue.y; w = newValue.z } }
  public var ywx: SIMD3<Scalar> { get { SIMD3<Scalar>(y, w, x) } set { y = newValue.x; w = newValue.y; x = newValue.z } }
  public var ywy: SIMD3<Scalar> { SIMD3<Scalar>(y, w, y) }
  public var ywz: SIMD3<Scalar> { get { SIMD3<Scalar>(y, w, z) } set { y = newValue.x; w = newValue.y; z = newValue.z } }
  public var yww: SIMD3<Scalar> { SIMD3<Scalar>(y, w, w) }
  public var zxx: SIMD3<Scalar> { SIMD3<Scalar>(z, x, x) }
  public var zxy: SIMD3<Scalar> { get { SIMD3<Scalar>(z, x, y) } set { z = newValue.x; x = newValue.y; y = newValue.z } }
  public var zxz: SIMD3<Scalar> { SIMD3<Scalar>(z, x, z) }
  public var zxw: SIMD3<Scalar> { get { SIMD3<Scalar>(z, x, w) } set { z = newValue.x; x = newValue.y; w = newValue.z } }
  public var zyx: SIMD3<Scalar> { get { SIMD3<Scalar>(z, y, x) } set { z = newValue.x; y = newValue.y; x = newValue.z } }
  public var zyy: SIMD3<Scalar> { SIMD3<Scalar>(z, y, y) }
  public var zyz: SIMD3<Scalar> { SIMD3<Scalar>(z, y, z) }
  public var zyw: SIMD3<Scalar> { get { SIMD3<Scalar>(z, y, w) } set { z = newValue.x; y = newValue.y; w = newValue.z } }
  ...
  public var zwx: SIMD3<Scalar> { get { SIMD3<Scalar>(z, w, x) } set { z = newValue.x; w = newValue.y; x = newValue.z } }
  public var zwy: SIMD3<Scalar> { get { SIMD3<Scalar>(z, w, y) } set { z = newValue.x; w = newValue.y; y = newValue.z } }
  ...
  public var wxy: SIMD3<Scalar> { get { SIMD3<Scalar>(w, x, y) } set { w = newValue.x; x = newValue.y; y = newValue.z } }
  public var wxz: SIMD3<Scalar> { get { SIMD3<Scalar>(w, x, z) } set { w = newValue.x; x = newValue.y; z = newValue.z } }
  public var wxw: SIMD3<Scalar> { SIMD3<Scalar>(w, x, w) }
  public var wyx: SIMD3<Scalar> { get { SIMD3<Scalar>(w, y, x) } set { w = newValue.x; y = newValue.y; x = newValue.z } }
  public var wyy: SIMD3<Scalar> { SIMD3<Scalar>(w, y, y) }
  public var wyz: SIMD3<Scalar> { get { SIMD3<Scalar>(w, y, z) } set { w = newValue.x; y = newValue.y; z = newValue.z } }
  public var wyw: SIMD3<Scalar> { SIMD3<Scalar>(w, y, w) }
  public var wzx: SIMD3<Scalar> { get { SIMD3<Scalar>(w, z, x) } set { w = newValue.x; z = newValue.y; x = newValue.z } }
  public var wzy: SIMD3<Scalar> { get { SIMD3<Scalar>(w, z, y) } set { w = newValue.x; z = newValue.y; y = newValue.z } }
  ...
  public var rgb: SIMD3<Scalar> { get { SIMD3<Scalar>(r, g, b) } set { r = newValue.x; g = newValue.y; b = newValue.z } }
  public var rga: SIMD3<Scalar> { get { SIMD3<Scalar>(r, g, a) } set { r = newValue.x; g = newValue.y; a = newValue.z } }
  public var rbr: SIMD3<Scalar> { SIMD3<Scalar>(r, b, r) }
  public var rbg: SIMD3<Scalar> { get { SIMD3<Scalar>(r, b, g) } set { r = newValue.x; b = newValue.y; g = newValue.z } }
  public var rbb: SIMD3<Scalar> { SIMD3<Scalar>(r, b, b) }
  public var rba: SIMD3<Scalar> { get { SIMD3<Scalar>(r, b, a) } set { r = newValue.x; b = newValue.y; a = newValue.z } }
  public var rar: SIMD3<Scalar> { SIMD3<Scalar>(r, a, r) }
  public var rag: SIMD3<Scalar> { get { SIMD3<Scalar>(r, a, g) } set { r = newValue.x; a = newValue.y; g = newValue.z } }
  public var rab: SIMD3<Scalar> { get { SIMD3<Scalar>(r, a, b) } set { r = newValue.x; a = newValue.y; b = newValue.z } }
  ...
  public var grb: SIMD3<Scalar> { get { SIMD3<Scalar>(g, r, b) } set { g = newValue.x; r = newValue.y; b = newValue.z } }
  public var gra: SIMD3<Scalar> { get { SIMD3<Scalar>(g, r, a) } set { g = newValue.x; r = newValue.y; a = newValue.z } }
  ...
  public var gbr: SIMD3<Scalar> { get { SIMD3<Scalar>(g, b, r) } set { g = newValue.x; b = newValue.y; r = newValue.z } }
  public var gbg: SIMD3<Scalar> { SIMD3<Scalar>(g, b, g) }
  public var gbb: SIMD3<Scalar> { SIMD3<Scalar>(g, b, b) }
  public var gba: SIMD3<Scalar> { get { SIMD3<Scalar>(g, b, a) } set { g = newValue.x; b = newValue.y; a = newValue.z } }
  public var gar: SIMD3<Scalar> { get { SIMD3<Scalar>(g, a, r) } set { g = newValue.x; a = newValue.y; r = newValue.z } }
  public var gag: SIMD3<Scalar> { SIMD3<Scalar>(g, a, g) }
  public var gab: SIMD3<Scalar> { get { SIMD3<Scalar>(g, a, b) } set { g = newValue.x; a = newValue.y; b = newValue.z } }
  public var gaa: SIMD3<Scalar> { SIMD3<Scalar>(g, a, a) }
  public var brr: SIMD3<Scalar> { SIMD3<Scalar>(b, r, r) }
  public var brg: SIMD3<Scalar> { get { SIMD3<Scalar>(b, r, g) } set { b = newValue.x; r = newValue.y; g = newValue.z } }
  public var brb: SIMD3<Scalar> { SIMD3<Scalar>(b, r, b) }
  public var bra: SIMD3<Scalar> { get { SIMD3<Scalar>(b, r, a) } set { b = newValue.x; r = newValue.y; a = newValue.z } }
  public var bgr: SIMD3<Scalar> { get { SIMD3<Scalar>(b, g, r) } set { b = newValue.x; g = newValue.y; r = newValue.z } }
  public var bgg: SIMD3<Scalar> { SIMD3<Scalar>(b, g, g) }
  public var bgb: SIMD3<Scalar> { SIMD3<Scalar>(b, g, b) }
  public var bga: SIMD3<Scalar> { get { SIMD3<Scalar>(b, g, a) } set { b = newValue.x; g = newValue.y; a = newValue.z } }
  ...
  public var bar: SIMD3<Scalar> { get { SIMD3<Scalar>(b, a, r) } set { b = newValue.x; a = newValue.y; r = newValue.z } }
  public var bag: SIMD3<Scalar> { get { SIMD3<Scalar>(b, a, g) } set { b = newValue.x; a = newValue.y; g = newValue.z } }
  ...
  public var arg: SIMD3<Scalar> { get { SIMD3<Scalar>(a, r, g) } set { a = newValue.x; r = newValue.y; g = newValue.z } }
  public var arb: SIMD3<Scalar> { get { SIMD3<Scalar>(a, r, b) } set { a = newValue.x; r = newValue.y; b = newValue.z } }
  public var ara: SIMD3<Scalar> { SIMD3<Scalar>(a, r, a) }
  public var agr: SIMD3<Scalar> { get { SIMD3<Scalar>(a, g, r) } set { a = newValue.x; g = newValue.y; r = newValue.z } }
  public var agg: SIMD3<Scalar> { SIMD3<Scalar>(a, g, g) }
  public var agb: SIMD3<Scalar> { get { SIMD3<Scalar>(a, g, b) } set { a = newValue.x; g = newValue.y; b = newValue.z } }
  public var aga: SIMD3<Scalar> { SIMD3<Scalar>(a, g, a) }
  public var abr: SIMD3<Scalar> { get { SIMD3<Scalar>(a, b, r) } set { a = newValue.x; b = newValue.y; r = newValue.z } }
  public var abg: SIMD3<Scalar> { get { SIMD3<Scalar>(a, b, g) } set { a = newValue.x; b = newValue.y; g = newValue.z } }
  ...
  public var stp: SIMD3<Scalar> { get { SIMD3<Scalar>(s, t, p) } set { s = newValue.x; t = newValue.y; p = newValue.z } }
  public var stq: SIMD3<Scalar> { get { SIMD3<Scalar>(s, t, q) } set { s = newValue.x; t = newValue.y; q = newValue.z } }
  public var sps: SIMD3<Scalar> { SIMD3<Scalar>(s, p, s) }
  public var spt: SIMD3<Scalar> { get { SIMD3<Scalar>(s, p, t) } set { s = newValue.x; p = newValue.y; t = newValue.z } }
  public var spp: SIMD3<Scalar> { SIMD3<Scalar>(s, p, p) }
  public var spq: SIMD3<Scalar> { get { SIMD3<Scalar>(s, p, q) } set { s = newValue.x; p = newValue.y; q = newValue.z } }
  public var sqs: SIMD3<Scalar> { SIMD3<Scalar>(s, q, s) }
  public var sqt: SIMD3<Scalar> { get { SIMD3<Scalar>(s, q, t) } set { s = newValue.x; q = newValue.y; t = newValue.z } }
  public var sqp: SIMD3<Scalar> { get { SIMD3<Scalar>(s, q, p) } set { s = newValue.x; q = newValue.y; p = newValue.z } }
  ...
  public var tsp: SIMD3<Scalar> { get { SIMD3<Scalar>(t, s, p) } set { t = newValue.x; s = newValue.y; p = newValue.z } }
  public var tsq: SIMD3<Scalar> { get { SIMD3<Scalar>(t, s, q) } set { t = newValue.x; s = newValue.y; q = newValue.z } }
  ...
  public var tps: SIMD3<Scalar> { get { SIMD3<Scalar>(t, p, s) } set { t = newValue.x; p = newValue.y; s = newValue.z } }
  public var tpt: SIMD3<Scalar> { SIMD3<Scalar>(t, p, t) }
  public var tpp: SIMD3<Scalar> { SIMD3<Scalar>(t, p, p) }
  public var tpq: SIMD3<Scalar> { get { SIMD3<Scalar>(t, p, q) } set { t = newValue.x; p = newValue.y; q = newValue.z } }
  public var tqs: SIMD3<Scalar> { get { SIMD3<Scalar>(t, q, s) } set { t = newValue.x; q = newValue.y; s = newValue.z } }
  public var tqt: SIMD3<Scalar> { SIMD3<Scalar>(t, q, t) }
  public var tqp: SIMD3<Scalar> { get { SIMD3<Scalar>(t, q, p) } set { t = newValue.x; q = newValue.y; p = newValue.z } }
  public var tqq: SIMD3<Scalar> { SIMD3<Scalar>(t, q, q) }
  public var pss: SIMD3<Scalar> { SIMD3<Scalar>(p, s, s) }
  public var pst: SIMD3<Scalar> { get { SIMD3<Scalar>(p, s, t) } set { p = newValue.x; s = newValue.y; t = newValue.z } }
  public var psp: SIMD3<Scalar> { SIMD3<Scalar>(p, s, p) }
  public var psq: SIMD3<Scalar> { get { SIMD3<Scalar>(p, s, q) } set { p = newValue.x; s = newValue.y; q = newValue.z } }
  public var pts: SIMD3<Scalar> { get { SIMD3<Scalar>(p, t, s) } set { p = newValue.x; t = newValue.y; s = newValue.z } }
  public var ptt: SIMD3<Scalar> { SIMD3<Scalar>(p, t, t) }
  public var ptp: SIMD3<Scalar> { SIMD3<Scalar>(p, t, p) }
  public var ptq: SIMD3<Scalar> { get { SIMD3<Scalar>(p, t, q) } set { p = newValue.x; t = newValue.y; q = newValue.z } }
  ...
  public var pqs: SIMD3<Scalar> { get { SIMD3<Scalar>(p, q, s) } set { p = newValue.x; q = newValue.y; s = newValue.z } }
  public var pqt: SIMD3<Scalar> { get { SIMD3<Scalar>(p, q, t) } set { p = newValue.x; q = newValue.y; t = newValue.z } }
  ...
  public var qst: SIMD3<Scalar> { get { SIMD3<Scalar>(q, s, t) } set { q = newValue.x; s = newValue.y; t = newValue.z } }
  public var qsp: SIMD3<Scalar> { get { SIMD3<Scalar>(q, s, p) } set { q = newValue.x; s = newValue.y; p = newValue.z } }
  public var qsq: SIMD3<Scalar> { SIMD3<Scalar>(q, s, q) }
  public var qts: SIMD3<Scalar> { get { SIMD3<Scalar>(q, t, s) } set { q = newValue.x; t = newValue.y; s = newValue.z } }
  public var qtt: SIMD3<Scalar> { SIMD3<Scalar>(q, t, t) }
  public var qtp: SIMD3<Scalar> { get { SIMD3<Scalar>(q, t, p) } set { q = newValue.x; t = newValue.y; p = newValue.z } }
  public var qtq: SIMD3<Scalar> { SIMD3<Scalar>(q, t, q) }
  public var qps: SIMD3<Scalar> { get { SIMD3<Scalar>(q, p, s) } set { q = newValue.x; p = newValue.y; s = newValue.z } }
  public var qpt: SIMD3<Scalar> { get { SIMD3<Scalar>(q, p, t) } set { q = newValue.x; p = newValue.y; t = newValue.z } }
  ...
  public var xyzw: SIMD4<Scalar> { get { SIMD4<Scalar>(x, y, z, w) } set { x = newValue.x; y = newValue.y; z = newValue.z; w = newValue.w } }
  public var xywx: SIMD4<Scalar> { SIMD4<Scalar>(x, y, w, x) }
  public var xywy: SIMD4<Scalar> { SIMD4<Scalar>(x, y, w, y) }
  public var xywz: SIMD4<Scalar> { get { SIMD4<Scalar>(x, y, w, z) } set { x = newValue.x; y = newValue.y; w = newValue.z; z = newValue.w } }
  ...
  public var xzyw: SIMD4<Scalar> { get { SIMD4<Scalar>(x, z, y, w) } set { x = newValue.x; z = newValue.y; y = newValue.z; w = newValue.w } }
  ...
  public var xzwy: SIMD4<Scalar> { get { SIMD4<Scalar>(x, z, w, y) } set { x = newValue.x; z = newValue.y; w = newValue.z; y = newValue.w } }
  ...
  public var xwyz: SIMD4<Scalar> { get { SIMD4<Scalar>(x, w, y, z) } set { x = newValue.x; w = newValue.y; y = newValue.z; z = newValue.w } }
  public var xwyw: SIMD4<Scalar> { SIMD4<Scalar>(x, w, y, w) }
  public var xwzx: SIMD4<Scalar> { SIMD4<Scalar>(x, w, z, x) }
  public var xwzy: SIMD4<Scalar> { get { SIMD4<Scalar>(x, w, z, y) } set { x = newValue.x; w = newValue.y; z = newValue.z; y = newValue.w } }
  ...
  public var yxzw: SIMD4<Scalar> { get { SIMD4<Scalar>(y, x, z, w) } set { y = newValue.x; x = newValue.y; z = newValue.z; w = newValue.w } }
  public var yxwx: SIMD4<Scalar> { SIMD4<Scalar>(y, x, w, x) }
  public var yxwy: SIMD4<Scalar> { SIMD4<Scalar>(y, x, w, y) }
  public var yxwz: SIMD4<Scalar> { get { SIMD4<Scalar>(y, x, w, z) } set { y = newValue.x; x = newValue.y; w = newValue.z; z = newValue.w } }
  ...
  public var yzxw: SIMD4<Scalar> { get { SIMD4<Scalar>(y, z, x, w) } set { y = newValue.x; z = newValue.y; x = newValue.z; w = newValue.w } }
  ...
  public var yzwx: SIMD4<Scalar> { get { SIMD4<Scalar>(y, z, w, x) } set { y = newValue.x; z = newValue.y; w = newValue.z; x = newValue.w } }
  ...
  public var ywxz: SIMD4<Scalar> { get { SIMD4<Scalar>(y, w, x, z) } set { y = newValue.x; w = newValue.y; x = newValue.z; z = newValue.w } }
  ...
  public var ywzx: SIMD4<Scalar> { get { SIMD4<Scalar>(y, w, z, x) } set { y = newValue.x; w = newValue.y; z = newValue.z; x = newValue.w } }
  ...
  public var zxyw: SIMD4<Scalar> { get { SIMD4<Scalar>(z, x, y, w) } set { z = newValue.x; x = newValue.y; y = newValue.z; w = newValue.w } }
  ...
  public var zxwy: SIMD4<Scalar> { get { SIMD4<Scalar>(z, x, w, y) } set { z = newValue.x; x = newValue.y; w = newValue.z; y = newValue.w } }
  ...
  public var zyxw: SIMD4<Scalar> { get { SIMD4<Scalar>(z, y, x, w) } set { z = newValue.x; y = newValue.y; x = newValue.z; w = newValue.w } }
  ...
  public var zywx: SIMD4<Scalar> { get { SIMD4<Scalar>(z, y, w, x) } set { z = newValue.x; y = newValue.y; w = newValue.z; x = newValue.w } }
  ...
  public var zwxy: SIMD4<Scalar> { get { SIMD4<Scalar>(z, w, x, y) } set { z = newValue.x; w = newValue.y; x = newValue.z; y = newValue.w } }
  public var zwxz: SIMD4<Scalar> { SIMD4<Scalar>(z, w, x, z) }
  public var zwxw: SIMD4<Scalar> { SIMD4<Scalar>(z, w, x, w) }
  public var zwyx: SIMD4<Scalar> { get { SIMD4<Scalar>(z, w, y, x) } set { z = newValue.x; w = newValue.y; y = newValue.z; x = newValue.w } }
  ...
  public var wxyz: SIMD4<Scalar> { get { SIMD4<Scalar>(w, x, y, z) } set { w = newValue.x; x = newValue.y; y = newValue.z; z = newValue.w } }
  public var wxyw: SIMD4<Scalar> { SIMD4<Scalar>(w, x, y, w) }
  public var wxzx: SIMD4<Scalar> { SIMD4<Scalar>(w, x, z, x) }
  public var wxzy: SIMD4<Scalar> { get { SIMD4<Scalar>(w, x, z, y) } set { w = newValue.x; x = newValue.y; z = newValue.z; y = newValue.w } }
  ...
  public var wyxz: SIMD4<Scalar> { get { SIMD4<Scalar>(w, y, x, z) } set { w = newValue.x; y = newValue.y; x = newValue.z; z = newValue.w } }
  ...
  public var wyzx: SIMD4<Scalar> { get { SIMD4<Scalar>(w, y, z, x) } set { w = newValue.x; y = newValue.y; z = newValue.z; x = newValue.w } }
  ...
  public var wzxy: SIMD4<Scalar> { get { SIMD4<Scalar>(w, z, x, y) } set { w = newValue.x; z = newValue.y; x = newValue.z; y = newValue.w } }
  public var wzxz: SIMD4<Scalar> { SIMD4<Scalar>(w, z, x, z) }
  public var wzxw: SIMD4<Scalar> { SIMD4<Scalar>(w, z, x, w) }
  public var wzyx: SIMD4<Scalar> { get { SIMD4<Scalar>(w, z, y, x) } set { w = newValue.x; z = newValue.y; y = newValue.z; x = newValue.w } }
  ...
  public var rgba: SIMD4<Scalar> { get { SIMD4<Scalar>(r, g, b, a) } set { r = newValue.x; g = newValue.y; b = newValue.z; a = newValue.w } }
  public var rgar: SIMD4<Scalar> { SIMD4<Scalar>(r, g, a, r) }
  public var rgag: SIMD4<Scalar> { SIMD4<Scalar>(r, g, a, g) }
  public var rgab: SIMD4<Scalar> { get { SIMD4<Scalar>(r, g, a, b) } set { r = newValue.x; g = newValue.y; a = newValue.z; b = newValue.w } }
  ...
  public var rbga: SIMD4<Scalar> { get { SIMD4<Scalar>(r, b, g, a) } set { r = newValue.x; b = newValue.y; g = newValue.z; a = newValue.w } }
  ...
  public var rbag: SIMD4<Scalar> { get { SIMD4<Scalar>(r, b, a, g) } set { r = newValue.x; b = newValue.y; a = newValue.z; g = newValue.w } }
  ...
  public var ragb: SIMD4<Scalar> { get { SIMD4<Scalar>(r, a, g, b) } set { r = newValue.x; a = newValue.y; g = newValue.z; b = newValue.w } }
  public var raga: SIMD4<Scalar> { SIMD4<Scalar>(r, a, g, a) }
  public var rabr: SIMD4<Scalar> { SIMD4<Scalar>(r, a, b, r) }
  public var rabg: SIMD4<Scalar> { get { SIMD4<Scalar>(r, a, b, g) } set { r = newValue.x; a = newValue.y; b = newValue.z; g = newValue.w } }
  ...
  public var grba: SIMD4<Scalar> { get { SIMD4<Scalar>(g, r, b, a) } set { g = newValue.x; r = newValue.y; b = newValue.z; a = newValue.w } }
  public var grar: SIMD4<Scalar> { SIMD4<Scalar>(g, r, a, r) }
  public var grag: SIMD4<Scalar> { SIMD4<Scalar>(g, r, a, g) }
  public var grab: SIMD4<Scalar> { get { SIMD4<Scalar>(g, r, a, b) } set { g = newValue.x; r = newValue.y; a = newValue.z; b = newValue.w } }
  ...
  public var gbra: SIMD4<Scalar> { get { SIMD4<Scalar>(g, b, r, a) } set { g = newValue.x; b = newValue.y; r = newValue.z; a = newValue.w } }
  ...
  public var gbar: SIMD4<Scalar> { get { SIMD4<Scalar>(g, b, a, r) } set { g = newValue.x; b = newValue.y; a = newValue.z; r = newValue.w } }
  ...
  public var garb: SIMD4<Scalar> { get { SIMD4<Scalar>(g, a, r, b) } set { g = newValue.x; a = newValue.y; r = newValue.z; b = newValue.w } }
  ...
  public var gabr: SIMD4<Scalar> { get { SIMD4<Scalar>(g, a, b, r) } set { g = newValue.x; a = newValue.y; b = newValue.z; r = newValue.w } }
  ...
  public var brga: SIMD4<Scalar> { get { SIMD4<Scalar>(b, r, g, a) } set { b = newValue.x; r = newValue.y; g = newValue.z; a = newValue.w } }
  ...
  public var brag: SIMD4<Scalar> { get { SIMD4<Scalar>(b, r, a, g) } set { b = newValue.x; r = newValue.y; a = newValue.z; g = newValue.w } }
  ...
  public var bgra: SIMD4<Scalar> { get { SIMD4<Scalar>(b, g, r, a) } set { b = newValue.x; g = newValue.y; r = newValue.z; a = newValue.w } }
  ...
  public var bgar: SIMD4<Scalar> { get { SIMD4<Scalar>(b, g, a, r) } set { b = newValue.x; g = newValue.y; a = newValue.z; r = newValue.w } }
  ...
  public var barg: SIMD4<Scalar> { get { SIMD4<Scalar>(b, a, r, g) } set { b = newValue.x; a = newValue.y; r = newValue.z; g = newValue.w } }
  public var barb: SIMD4<Scalar> { SIMD4<Scalar>(b, a, r, b) }
  public var bara: SIMD4<Scalar> { SIMD4<Scalar>(b, a, r, a) }
  public var bagr: SIMD4<Scalar> { get { SIMD4<Scalar>(b, a, g, r) } set { b = newValue.x; a = newValue.y; g = newValue.z; r = newValue.w } }
  ...
  public var argb: SIMD4<Scalar> { get { SIMD4<Scalar>(a, r, g, b) } set { a = newValue.x; r = newValue.y; g = newValue.z; b = newValue.w } }
  public var arga: SIMD4<Scalar> { SIMD4<Scalar>(a, r, g, a) }
  public var arbr: SIMD4<Scalar> { SIMD4<Scalar>(a, r, b, r) }
  public var arbg: SIMD4<Scalar> { get { SIMD4<Scalar>(a, r, b, g) } set { a = newValue.x; r = newValue.y; b = newValue.z; g = newValue.w } }
  ...
  public var agrb: SIMD4<Scalar> { get { SIMD4<Scalar>(a, g, r, b) } set { a = newValue.x; g = newValue.y; r = newValue.z; b = newValue.w } }
  ...
  public var agbr: SIMD4<Scalar> { get { SIMD4<Scalar>(a, g, b, r) } set { a = newValue.x; g = newValue.y; b = newValue.z; r = newValue.w } }
  ...
  public var abrg: SIMD4<Scalar> { get { SIMD4<Scalar>(a, b, r, g) } set { a = newValue.x; b = newValue.y; r = newValue.z; g = newValue.w } }
  public var abrb: SIMD4<Scalar> { SIMD4<Scalar>(a, b, r, b) }
  public var abra: SIMD4<Scalar> { SIMD4<Scalar>(a, b, r, a) }
  public var abgr: SIMD4<Scalar> { get { SIMD4<Scalar>(a, b, g, r) } set { a = newValue.x; b = newValue.y; g = newValue.z; r = newValue.w } }
  ...
  public var stpq: SIMD4<Scalar> { get { SIMD4<Scalar>(s, t, p, q) } set { s = newValue.x; t = newValue.y; p = newValue.z; q = newValue.w } }
  public var stqs: SIMD4<Scalar> { SIMD4<Scalar>(s, t, q, s) }
  public var stqt: SIMD4<Scalar> { SIMD4<Scalar>(s, t, q, t) }
  public var stqp: SIMD4<Scalar> { get { SIMD4<Scalar>(s, t, q, p) } set { s = newValue.x; t = newValue.y; q = newValue.z; p = newValue.w } }
  ...
  public var sptq: SIMD4<Scalar> { get { SIMD4<Scalar>(s, p, t, q) } set { s = newValue.x; p = newValue.y; t = newValue.z; q = newValue.w } }
  ...
  public var spqt: SIMD4<Scalar> { get { SIMD4<Scalar>(s, p, q, t) } set { s = newValue.x; p = newValue.y; q = newValue.z; t = newValue.w } }
  ...
  public var sqtp: SIMD4<Scalar> { get { SIMD4<Scalar>(s, q, t, p) } set { s = newValue.x; q = newValue.y; t = newValue.z; p = newValue.w } }
  public var sqtq: SIMD4<Scalar> { SIMD4<Scalar>(s, q, t, q) }
  public var sqps: SIMD4<Scalar> { SIMD4<Scalar>(s, q, p, s) }
  public var sqpt: SIMD4<Scalar> { get { SIMD4<Scalar>(s, q, p, t) } set { s = newValue.x; q = newValue.y; p = newValue.z; t = newValue.w } }
  ...
  public var tspq: SIMD4<Scalar> { get { SIMD4<Scalar>(t, s, p, q) } set { t = newValue.x; s = newValue.y; p = newValue.z; q = newValue.w } }
  public var tsqs: SIMD4<Scalar> { SIMD4<Scalar>(t, s, q, s) }
  public var tsqt: SIMD4<Scalar> { SIMD4<Scalar>(t, s, q, t) }
  public var tsqp: SIMD4<Scalar> { get { SIMD4<Scalar>(t, s, q, p) } set { t = newValue.x; s = newValue.y; q = newValue.z; p = newValue.w } }
  ...
  public var tpsq: SIMD4<Scalar> { get { SIMD4<Scalar>(t, p, s, q) } set { t = newValue.x; p = newValue.y; s = newValue.z; q = newValue.w } }
  ...
  public var tpqs: SIMD4<Scalar> { get { SIMD4<Scalar>(t, p, q, s) } set { t = newValue.x; p = newValue.y; q = newValue.z; s = newValue.w } }
  ...
  public var tqsp: SIMD4<Scalar> { get { SIMD4<Scalar>(t, q, s, p) } set { t = newValue.x; q = newValue.y; s = newValue.z; p = newValue.w } }
  ...
  public var tqps: SIMD4<Scalar> { get { SIMD4<Scalar>(t, q, p, s) } set { t = newValue.x; q = newValue.y; p = newValue.z; s = newValue.w } }
  ...
  public var pstq: SIMD4<Scalar> { get { SIMD4<Scalar>(p, s, t, q) } set { p = newValue.x; s = newValue.y; t = newValue.z; q = newValue.w } }
  ...
  public var psqt: SIMD4<Scalar> { get { SIMD4<Scalar>(p, s, q, t) } set { p = newValue.x; s = newValue.y; q = newValue.z; t = newValue.w } }
  ...
  public var ptsq: SIMD4<Scalar> { get { SIMD4<Scalar>(p, t, s, q) } set { p = newValue.x; t = newValue.y; s = newValue.z; q = newValue.w } }
  ...
  public var ptqs: SIMD4<Scalar> { get { SIMD4<Scalar>(p, t, q, s) } set { p = newValue.x; t = newValue.y; q = newValue.z; s = newValue.w } }
  ...
  public var pqst: SIMD4<Scalar> { get { SIMD4<Scalar>(p, q, s, t) } set { p = newValue.x; q = newValue.y; s = newValue.z; t = newValue.w } }
  public var pqsp: SIMD4<Scalar> { SIMD4<Scalar>(p, q, s, p) }
  public var pqsq: SIMD4<Scalar> { SIMD4<Scalar>(p, q, s, q) }
  public var pqts: SIMD4<Scalar> { get { SIMD4<Scalar>(p, q, t, s) } set { p = newValue.x; q = newValue.y; t = newValue.z; s = newValue.w } }
  ...
  public var qstp: SIMD4<Scalar> { get { SIMD4<Scalar>(q, s, t, p) } set { q = newValue.x; s = newValue.y; t = newValue.z; p = newValue.w } }
  public var qstq: SIMD4<Scalar> { SIMD4<Scalar>(q, s, t, q) }
  public var qsps: SIMD4<Scalar> { SIMD4<Scalar>(q, s, p, s) }
  public var qspt: SIMD4<Scalar> { get { SIMD4<Scalar>(q, s, p, t) } set { q = newValue.x; s = newValue.y; p = newValue.z; t = newValue.w } }
  ...
  public var qtsp: SIMD4<Scalar> { get { SIMD4<Scalar>(q, t, s, p) } set { q = newValue.x; t = newValue.y; s = newValue.z; p = newValue.w } }
  ...
  public var qtps: SIMD4<Scalar> { get { SIMD4<Scalar>(q, t, p, s) } set { q = newValue.x; t = newValue.y; p = newValue.z; s = newValue.w } }
  ...
  public var qpst: SIMD4<Scalar> { get { SIMD4<Scalar>(q, p, s, t) } set { q = newValue.x; p = newValue.y; s = newValue.z; t = newValue.w } }
  public var qpsp: SIMD4<Scalar> { SIMD4<Scalar>(q, p, s, p) }
  public var qpsq: SIMD4<Scalar> { SIMD4<Scalar>(q, p, s, q) }
  public var qpts: SIMD4<Scalar> { get { SIMD4<Scalar>(q, p, t, s) } set { q = newValue.x; p = newValue.y; t = newValue.z; s = newValue.w } }
